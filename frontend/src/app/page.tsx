      ...
      <header className="sticky top-0 z-50 bg-[#FAF8F5]/90 backdrop-blur-md border-b border-stone-200/60 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-stone-700">
            <a href="#pol-areas" className="text-[#B84A22] font-semibold underline underline-offset-8 decoration-2">
              Pol Areas
            </a>
            <a href="#experiences" className="hover:text-[#1E5A5B] transition-colors">
              Experiences
            </a>
            <a href="#heritage-map" className="hover:text-[#1E5A5B] transition-colors">
              Heritage Map
            </a>
          </nav>

          <div className="flex items-center gap-4">
            <button className="p-2 text-stone-600 hover:text-[#1E5A5B] hover:bg-stone-100 rounded-full transition" title="Language Picker">
